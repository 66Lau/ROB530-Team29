...
int main(int argc, char** argv) {
  ...
  std::string velocity_topic_rough
  = config["subscribers"]["velocity_topic_rough"].as<std::string>();
  ...
  auto qv_and_mutex_rough = ros_sub.AddVelocityWithCovarianceSubscriber(velocity_topic_rough);
  auto qv_rough = qv_and_mutex_rough.first;
  auto qv_mutex_rough = qv_and_mutex_rough.second;
  ...
  inekf_estimator.add_velocity_correction(
    qv, qv_mutex, project_dir + "/config/mini_cheetah/velocity_correction.yaml");

  // inekf_estimator.add_velocity_correction(
  //   qv_rough, qv_mutex_rough, project_dir + "/config/mini_cheetah/velocity_correction_rough.yaml");
